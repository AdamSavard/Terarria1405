...
namespace Terraria.Initializers
{
  public static class AssetInitializer
  {
    public static void CreateAssetServices(GameServiceContainer services)
    {
      ...
      readerCollection.RegisterReader((IAssetReader) new PngReader(((IGraphicsDeviceService) XnaExtensions.Get<IGraphicsDeviceService>((IServiceProvider) services)).GraphicsDevice), new string[1]
      {
        ".png"
      });
