...
namespace Terraria.Initializers
{
  public class AchievementInitializer
  {
    ...
    {
      Main.NewText(Language.GetTextValue("Achievements.Completed", (object) AchievementTagHandler.GenerateTag(achievement)), byte.MaxValue, byte.MaxValue, byte.MaxValue);
