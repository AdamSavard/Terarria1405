...
namespace Terraria.Initializers
{
  public static class ChromaInitializer
  {
    ...
    public static void Load()
    {
      ...
      ChromaInitializer.RegisterShader("Underground Crimson", (ChromaShader) new DrippingShader(new Color(0.05f, 0.0f, 0.0f), new Color((int) byte.MaxValue, 0, 0), 1f), CommonConditions.UndergroundBiome.Crimson, (ShaderLayer) 2);
