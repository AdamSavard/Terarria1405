...
namespace Terraria
{
  public class Collision
  {
      ...
      bool fall = false)
    {
      ...
      int Width1 = Width;
      int Height1 = Height;
      Vector2 vector2_6 = Collision.TileCollision(Position1, Velocity1, Width1, Height1, false, false, 1);
...
label_19:
      ...
      int specialChecksMode = 0)
    {
      ...
      else
      {
        Tile tile3 = Main.tile[x, index1 - gravDir];
        Tile tile4 = Main.tile[x, index1 - (num2 + 1) * gravDir];
        flag7 = flag4 && (!tile3.nactive() || !Main.tileSolid[(int) tile3.type] || (Main.tileSolidTop[(int) tile3.type] || tile3.slope() != (byte) 0) || tile3.halfBrick() && (!tile4.nactive() || !Main.tileSolid[(int) tile4.type] || Main.tileSolidTop[(int) tile4.type]));
        Tile tile5 = Main.tile[x, index1];
        tile2 = Main.tile[x, index1 + 1];
        flag8 = flag5 && (tile5.nactive() && (Main.tileSolid[(int) tile5.type] && !Main.tileSolidTop[(int) tile5.type] || holdsMatching && Main.tileSolidTop[(int) tile5.type] && tile5.frameY == (short) 0 && (!Main.tileSolid[(int) tile2.type] || !tile2.nactive())) || tile2.halfBrick() && tile2.nactive());
      }
