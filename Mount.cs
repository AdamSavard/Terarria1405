...
namespace Terraria
{
  public class Mount
  {
    ...
    {
      SoundEngine.PlaySound(37, (int) Position.X + Width / 2, (int) Position.Y + Height / 2, 5, 1f, 0.0f);
    }

    private static void MeowcartBumperSound(Vector2 Position, int Width, int Height)
    {
      SoundEngine.PlaySound(37, (int) Position.X + Width / 2, (int) Position.Y + Height / 2, 3, 1f, 0.0f);
    }
    ...
    public int PlayerOffset
    {
      get
      {
        return !this._active ? 0 : this._data.playerYOffsets[this._frame];
      }
    }
    ...
    public int PlayerOffsetHitbox
    {
      get
      {
        return !this._active ? 0 : -this.PlayerOffset + this._data.heightBoost;
      }
    }
    ...
    public int PlayerHeadOffset
    {
      get
      {
        return !this._active ? 0 : this._data.playerHeadOffset;
      }
    }
    ...
    public Mount.MountDelegatesData Delegations
    {
      get
      {
        return this._data == null ? this._defaultDelegatesData : this._data.delegations;
      }
    }
      ...
      for (int index1 = 0; index1 < mountSpecificData.beams.Length; ++index1)
      {
        ...
        if (beam.cooldown == 0)
        {
          ...
          if (point16 != Point16.NegativeOne)
          {
            ...
            {
              bool flag2 = true;
              if (WorldGen.InWorld((int) point16.X, (int) point16.Y, 0) && Main.tile[(int) point16.X, (int) point16.Y] != null && (Main.tile[(int) point16.X, (int) point16.Y].type == (ushort) 26 && !Main.hardMode))
              {
                flag2 = false;
            ...
            if (flag1)
              Tile.SmoothSlope((int) point16.X, (int) point16.Y, true, true);
      ...
      switch (this._type)
      {
        ...
        case 9:
          ...
          for (int index = 0; index < 2; ++index)
          {
            ...
            int Damage = 100;
            vector2_2 += vector2_4;
            Projectile.NewProjectile(vector2_2.X, vector2_2.Y, vector2_4.X, vector2_4.Y, Type1, Damage, 0.0f, Main.myPlayer, 0.0f, 0.0f);
          }
          break;
        case 46:
          if (Main.myPlayer != mountedPlayer.whoAmI)
          ...
          {
            int Damage = 120;
            Vector2 vector2_2 = mountedPlayer.Center + new Vector2((float) (mountedPlayer.width * -mountedPlayer.direction), 26f);
            Vector2 vector2_3 = new Vector2(0.0f, -4f).RotatedByRandom(0.100000001490116);
            Projectile.NewProjectile(vector2_2.X, vector2_2.Y, vector2_3.X, vector2_3.Y, 930, Damage, 0.0f, Main.myPlayer, 0.0f, 0.0f);
            SoundEngine.PlaySound(SoundID.Item89.SoundId, (int) vector2_2.X, (int) vector2_2.Y, SoundID.Item89.Style, 0.2f, 0.0f);
          }
          int Type2 = 14;
          int Damage1 = 100;
          mousePosition = this.ClampToDeadZone(mountedPlayer, mousePosition);
          Vector2 vector2_5;
          vector2_5.X = mountedPlayer.position.X + (float) (mountedPlayer.width / 2);
          vector2_5.Y = mountedPlayer.position.Y + (float) mountedPlayer.height;
          Vector2 vector2_6 = new Vector2(vector2_5.X + (float) (mountedPlayer.width * mountedPlayer.direction), vector2_5.Y - 12f);
          Vector2 vector2_7 = ((mousePosition - vector2_6).SafeNormalize(Vector2.Zero) * 12f).RotatedByRandom(0.200000002980232);
          Projectile.NewProjectile(vector2_6.X, vector2_6.Y, vector2_7.X, vector2_7.Y, Type2, Damage1, 0.0f, Main.myPlayer, 0.0f, 0.0f);
          SoundEngine.PlaySound(SoundID.Item11.SoundId, (int) vector2_6.X, (int) vector2_6.Y, SoundID.Item11.Style, 0.2f, 0.0f);
          break;
      }
    }
    ...
    public bool Hover(Player mountedPlayer)
    {
      ...
      else if ((double) mountedPlayer.velocity.Y == 0.0)
      {
        ...
        if ((double) Collision.TileCollision(mountedPlayer.position, Velocity, mountedPlayer.width, mountedPlayer.height, false, false, (int) mountedPlayer.gravDir).Y != 0.0 || mountedPlayer.controlDown)
      ...
      {
        float num1 = MathHelper.Clamp(-mountedPlayer.velocity.Y / this._data.dashSpeed, -1f, 1f);
        float num2 = MathHelper.Clamp(mountedPlayer.velocity.X / this._data.dashSpeed, -1f, 1f);
        float num3 = -0.1963495f * num1 * (float) mountedPlayer.direction + 0.1963495f * num2;
        mountedPlayer.fullRotation = num3;
    ...
    {
      return new Vector2((float) (27 * player.direction), 5f);
    }
      ...
      switch (this._type)
      {
        ...
        case 47:
          ...
          if (state == 1)
          {
            ...
            if (((this._type == 10 ? 1 : (this._type == 47 ? 1 : 0)) & (flag2 ? 1 : 0)) != 0)
            {
              ...
              {
                Dust dust = Main.dust[Dust.NewDust(Position, 0, 0, Type, 0.0f, 0.0f, 0, new Color(), 1f)];
        ...
        case 14:
          ...
          if (num8 != 0 && (double) velocity.Y == 0.0)
          {
            ...
            if (mountedPlayer.cMount == 0)
            {
              ...
              player1.position = player1.position + new Vector2(num9 * 24f, 0.0f);
              mountedPlayer.FloorVisuals(true);
              Player player2 = mountedPlayer;
              player2.position = player2.position - new Vector2(num9 * 24f, 0.0f);
            }
          }
        ...
        case 44:
          ...
          else if (!mountSpecificData1 & flag3)
          {
            ...
            Vector2 vector2_1 = new Vector2(40f, 30f);
            float num1 = 6.283185f * Main.rand.NextFloat();
            for (float num2 = 0.0f; (double) num2 < 20.0; ++num2)
            {
              Dust dust = Main.dust[Dust.NewDust(Position, 0, 0, 228, 0.0f, 0.0f, 0, new Color(), 1f)];
              Vector2 vector2_2 = Vector2.UnitY.RotatedBy((double) num2 * 6.28318548202515 / 20.0 + (double) num1, new Vector2()) * 0.8f;
              dust.position = Position + vector2_2 * vector2_1;
              dust.velocity = vector2_2 + new Vector2(this.RunSpeed - (float) Math.Sign(velocity.Length()), 0.0f);
          ...
          {
            int Height = 22;
            int num1 = mountedPlayer.width / 2 + 10;
            Vector2 bottom = mountedPlayer.Bottom;
            bottom.X -= (float) num1;
            bottom.Y -= (float) (Height - 6);
            Dust dust = Main.dust[Dust.NewDust(bottom, num1 * 2, Height, 228, 0.0f, 0.0f, 0, new Color(), 1f)];
            dust.velocity = Vector2.Zero;
            dust.noGravity = true;
            dust.noLight = true;
        ...
        case 45:
          ...
          if (flag4)
          {
            ...
            int num1 = 6;
            Dust dust = Main.dust[Dust.NewDust(mountedPlayer.Center - new Vector2((float) num1, (float) (num1 - 12)), num1 * 2, num1 * 2, Type, 0.0f, 0.0f, 0, new Color(), 1f)];
        ...
        case 49:
          ...
          double num11 = (double) velocity.Length();
          float num12 = mountedPlayer.velocity.Y * 0.05f;
      ...
      switch (state)
      {
        ...
        case 1:
          ...
          switch (this._type)
          {
            ...
            case 9:
            case 46:
              num13 = !this._flipDraw ? Math.Abs(velocity.X) : -Math.Abs(velocity.X);
              break;
            case 13:
              num13 = this._flipDraw ? velocity.X : -velocity.X;
              break;
            case 44:
              num13 = Math.Max(1f, Math.Abs(velocity.X) * 0.25f);
              break;
            case 48:
              num13 = Math.Max(0.5f, velocity.Length() * 0.125f);
              break;
            case 50:
              num13 = Math.Abs(velocity.X) * 0.5f;
              break;
            default:
        ...
        case 2:
          ...
          if (this._type != 23)
            break;
          float num14 = mountedPlayer.velocity.Length();
          if ((double) num14 < 1.0)
          {
            this._frame = 0;
            this._frameCounter = 0.0f;
    ...
    public void TryBeginningFlight(Player mountedPlayer, int state)
    {
      ...
      if ((double) Collision.TileCollision(mountedPlayer.position + new Vector2(0.0f, -1f / 1000f), Velocity, mountedPlayer.width, mountedPlayer.height, false, false, (int) mountedPlayer.gravDir).Y == 0.0)
        return;
    ...
    public void TryLanding(Player mountedPlayer)
    {
      ...
      if ((double) Collision.TileCollision(mountedPlayer.position, Velocity, mountedPlayer.width, mountedPlayer.height, false, false, (int) mountedPlayer.gravDir).Y != 0.0)
        return;
    ...
    private static void EmitGolfCartSmoke(Player mountedPlayer, bool rushing)
    {
      ...
      Dust dust = Dust.NewDustDirect(Position, 0, 0, 31, (float) -mountedPlayer.direction, (float) (-(double) mountedPlayer.gravDir * 0.239999994635582), 100, new Color(), 1f);
    ...
    private void DoGemMinecartEffect(Player mountedPlayer, int dustType)
    {
      ...
      Dust dust = Dust.NewDustPerfect(mountedPlayer.RotatedRelativePoint(pos, false, true), dustType, new Vector2?(), 0, new Color(), 1f);
      dust.noGravity = true;
      dust.fadeIn = 0.6f;
      dust.scale = 0.4f;
      dust.velocity *= 0.25f;
    ...
    private void DoConfettiMinecartEffect(Player mountedPlayer)
    {
      ...
      while (num2 > 0)
      {
        ...
        if (num2 > 0)
          vector2_2 += mountedPlayer.velocity * (float) (num2 / 3);
        Vector2 pos = mountedPlayer.Center + vector2_2 + vector2_1;
        Dust dust = Dust.NewDustPerfect(mountedPlayer.RotatedRelativePoint(pos, false, true), 139 + Main.rand.Next(4), new Vector2?(), 0, new Color(), 1f);
        dust.noGravity = true;
        dust.fadeIn = 0.6f;
    ...
    public void UpdateEffects(Player mountedPlayer)
    {
      ...
      switch (this._type)
      {
        ...
        case 46:
          ...
          if (flag1)
          {
            bool flag2 = this._abilityCooldown == 0;
            if (this._type == 46)
              flag2 = this._abilityCooldown % 10 == 0;
            if (flag2 && mountedPlayer.whoAmI == Main.myPlayer)
            {
        ...
        case 11:
          ...
          if (Main.netMode != 2)
          {
            ...
            if (num6 == -1)
              ++num3;
            Vector2 vector2_1 = new Vector2(num3 * (float) num6, -19f).RotatedBy((double) mountedPlayer.fullRotation, new Vector2());
            ...
            {
              int num4 = (int) Vector2.Distance(vector2_3, vector2_4) / 3;
              if ((double) Vector2.Distance(vector2_3, vector2_4) % 3.0 != 0.0)
                ++num4;
              for (float num7 = 1f; (double) num7 <= (double) num4; ++num7)
              {
                Dust dust = Main.dust[Dust.NewDust(mountedPlayer.Center, 0, 0, 182, 0.0f, 0.0f, 0, new Color(), 1f)];
                dust.position = Vector2.Lerp(vector2_4, vector2_3, num7 / (float) num4);
                dust.noGravity = true;
                dust.velocity = Vector2.Zero;
        ...
        case 22:
          ...
          Vector2 vector2_5 = mountedPlayer.RotatedRelativePoint(pos1, false, true);
          Vector2 vector2_6 = mountedPlayer.RotatedRelativePoint(pos2, false, true);
          Vector2 vector2_7 = mountedPlayer.RotatedRelativePoint(pos3, false, true);
          ...
          float num11 = MathHelper.Clamp(mountedPlayer.velocity.Length() / 5f, 0.0f, 1f);
          for (float amount = 0.0f; (double) amount <= 1.0; amount += 0.1f)
          {
            if ((double) Main.rand.NextFloat() >= (double) num11)
            {
              Dust dust = Dust.NewDustPerfect(Vector2.Lerp(vector2_11, vector2_10, amount), 65, new Vector2?(Main.rand.NextVector2Circular(0.5f, 0.5f) * num11), 0, new Color(), 1f);
              dust.scale = 0.6f;
              dust.fadeIn = 0.0f;
              dust.customData = (object) mountedPlayer;
              dust.velocity *= -1f;
        ...
        case 23:
          ...
          Vector2 vector2_13 = mountedPlayer.RotatedRelativePoint(pos4, false, true);
          Lighting.AddLight(vector2_13, rgb);
          if (Main.rand.Next(45) == 0)
          {
            Vector2 vector2_1 = Main.rand.NextVector2Circular(4f, 4f);
            Dust dust = Dust.NewDustPerfect(vector2_13 + vector2_1, 43, new Vector2?(Vector2.Zero), 254, new Color((int) byte.MaxValue, (int) byte.MaxValue, 0, (int) byte.MaxValue), 0.3f);
          ...
          float num12 = 0.1f + mountedPlayer.velocity.Length() / 30f;
          ...
          Vector2 vector2_14 = mountedPlayer.RotatedRelativePoint(pos5, false, true);
          Vector2 Origin = mountedPlayer.RotatedRelativePoint(pos6, false, true);
          if ((double) Main.rand.NextFloat() > (double) num12)
            break;
          float num13 = Main.rand.NextFloat();
          for (float num3 = 0.0f; (double) num3 < 1.0; num3 += 0.125f)
          {
            if (Main.rand.Next(15) == 0)
            {
              Vector2 vector2_1 = ((6.283185f * num3 + num13).ToRotationVector2() * new Vector2(0.5f, 1f) * 4f).RotatedBy((double) mountedPlayer.fullRotation, new Vector2());
              Dust dust = Dust.NewDustPerfect(vector2_14 + vector2_1, 43, new Vector2?(Vector2.Zero), 254, new Color((int) byte.MaxValue, (int) byte.MaxValue, 0, (int) byte.MaxValue), 0.3f);
              dust.velocity = vector2_1 * 0.025f + Origin.DirectionTo(dust.position) * 0.5f;
              dust.fadeIn = 0.3f;
              dust.noLightEmittence = true;
              dust.shader = GameShaders.Armor.GetSecondaryShader(mountedPlayer.cMount, mountedPlayer);
            }
      ...
      switch (this._type)
      {
        ...
        case 46:
          ...
          if ((double) this.AbilityCharge > 0.0)
          {
            ...
            for (int index = 0; index < 2; ++index)
            {
              Vector2 vector2_2 = new Vector2(vector2_1.X + (float) (mountedPlayer.width * mountedPlayer.direction), vector2_1.Y - 12f);
              Lighting.AddLight((int) ((double) vector2_2.X / 16.0), (int) ((double) vector2_2.Y / 16.0), 0.7f, 0.4f, 0.4f);
            }
          }
      ...
      float shadow)
    {
        ...
        case 35:
          if (drawType == 2)
          {
            ...
            if (effect.HasFlag((Enum) SpriteEffects.FlipHorizontally))
              num5 *= -1;
            Vector2 vector2 = new Vector2((float) num5, -26f);
      ...
      switch (this._type)
      {
        case 8:
          ...
          Vector2 vector2_1 = Mount.drillDiodePoint1.RotatedBy((double) mountSpecificData3.diodeRotation, new Vector2());
          Vector2 vector2_2 = Mount.drillDiodePoint2.RotatedBy((double) mountSpecificData3.diodeRotation, new Vector2());
        ...
        case 23:
          ...
          {
            drawData = new DrawData(texture2D1, (Position + ((float) index * 1.570796f).ToRotationVector2() * num6).Floor(), new Rectangle?(rectangle1), color4, rotation3, origin, scale1, effect, 0);
            drawData.shader = Mount.currentShader;
            playerDrawData.Add(drawData);
          }
          break;
    ...
    private void DoSpawnDust(Player mountedPlayer, bool isDismounting)
    {
      ...
      for (int index1 = 0; index1 < 100; ++index1)
      {
        ...
        else
        {
          ...
          int index2 = Dust.NewDust(new Vector2(mountedPlayer.position.X - 20f, mountedPlayer.position.Y), mountedPlayer.width + 40, mountedPlayer.height, Type, 0.0f, 0.0f, Alpha, newColor, Scale);
          ...
          if (this._type == 40 || this._type == 41 || this._type == 42)
            Main.dust[index2].velocity *= Main.rand.NextFloat();
        }
      }
      if (this._type == 40 || this._type == 41 || this._type == 42)
      {
        for (int index1 = 0; index1 < 5; ++index1)
        {
          ...
          int index2 = Gore.NewGore(new Vector2(mountedPlayer.position.X + (float) (mountedPlayer.direction * 8), mountedPlayer.position.Y + 20f), Vector2.Zero, Type, 1f);
          Main.gore[index2].alpha = 100;
          Main.gore[index2].velocity = Vector2.Transform(new Vector2(1f, 0.0f), Matrix.CreateRotationZ((float) (Main.rand.NextDouble() * 6.28318548202515))) * 1.4f;
        }
      }
      if (this._type != 23)
        return;
