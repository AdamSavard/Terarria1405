  ...
  public static class Modifiers
  {
    ...
    public class RadialDither : GenAction
    {
      ...
      public override bool Apply(Point origin, int x, int y, params object[] args)
      {
        ...
        return GenBase._random.NextDouble() > (double) Math.Max(0.0f, Math.Min(1f, (float) (((double) Vector2.Distance(new Vector2((float) x, (float) y), vector2) - (double) this._innerRadius) / ((double) this._outerRadius - (double) this._innerRadius)))) ? this.UnitApply(origin, x, y, args) : this.Fail();
      }
    }
