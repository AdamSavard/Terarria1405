...
namespace Terraria.GameContent.Biomes.CaveHouse
{
  public class DesertHouseBuilder : HouseBuilder
  {
    ...
    protected override void AgeRoom(Microsoft.Xna.Framework.Rectangle room)
    {
      ...
      {
        this.TileType
      }), (GenAction) new Actions.SetTileKeepWall((ushort) 396, true, true), (GenAction) new Modifiers.Dither(0.5), (GenAction) new Actions.SetTileKeepWall((ushort) 397, true, true)));
      ...
      WorldUtils.Gen(new Point(room.X, room.Y), (GenShape) new Shapes.Rectangle(room.Width, room.Height), Actions.Chain((GenAction) new Modifiers.Dither(0.800000011920929), (GenAction) new Modifiers.Blotches(2, 0.3), (GenAction) new Modifiers.OnlyWalls(new ushort[1]
      {
        this.WallType
      }), (GenAction) new Actions.PlaceWall((ushort) 216, true)));
    }
  }
}
