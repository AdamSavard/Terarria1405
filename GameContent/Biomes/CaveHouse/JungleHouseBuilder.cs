...
namespace Terraria.GameContent.Biomes.CaveHouse
{
  public class JungleHouseBuilder : HouseBuilder
  {
    ...
    protected override void AgeRoom(Microsoft.Xna.Framework.Rectangle room)
    {
      ...
      {
        this.TileType
      }), (GenAction) new Actions.SetTileKeepWall((ushort) 60, true, true), (GenAction) new Modifiers.Dither(0.800000011920929), (GenAction) new Actions.SetTileKeepWall((ushort) 59, true, true)));
      ...
      WorldUtils.Gen(new Point(room.X, room.Y), (GenShape) new Shapes.Rectangle(room.Width, room.Height), Actions.Chain((GenAction) new Modifiers.Dither(0.850000023841858), (GenAction) new Modifiers.Blotches(2, 0.3), (GenAction) new Actions.PlaceWall((ushort) 64, true)));
    }
  }
}
