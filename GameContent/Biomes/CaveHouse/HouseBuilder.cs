...
namespace Terraria.GameContent.Biomes.CaveHouse
{
  public class HouseBuilder
  {
    ...
    public Microsoft.Xna.Framework.Rectangle TopRoom
    {
      get
      {
        return this.Rooms.First<Microsoft.Xna.Framework.Rectangle>();
      }
    }

    public Microsoft.Xna.Framework.Rectangle BottomRoom
    {
      get
      {
        return this.Rooms.Last<Microsoft.Xna.Framework.Rectangle>();
      }
    }
    ...
    private void FillRooms()
    {
      ...
      foreach (Microsoft.Xna.Framework.Rectangle room in this.Rooms)
      {
        ...
        for (int index1 = 0; index1 < num1; ++index1)
        {
          ...
          switch (index1 + num3 % 2)
          {
            case 0:
              ...
              int y = (int) vector2.Y;
              WorldGen.PlaceTile(i, j1, x2, true, false, -1, y);
              break;
            case 1:
              int j2 = room.Y + 1;
              WorldGen.PlaceTile(i, j2, 34, true, false, -1, this._random.Next(6));
        ...
        for (; num4 > 0; --num4)
        {
          ...
          {
            case 0:
              WorldGen.PlaceSmallPile(num5, num6, this._random.Next(31, 34), 1, (ushort) 185);
              break;
            case 1:
              WorldGen.PlaceTile(num5, num6, 186, true, false, -1, this._random.Next(22, 26));
              break;
            case 2:
              int index = this._random.Next(2, WorldGen.statueList.Length);
              WorldGen.PlaceTile(num5, num6, (int) WorldGen.statueList[index].X, true, false, -1, (int) WorldGen.statueList[index].Y);
            ...
            case 3:
              ...
              WorldGen.PlaceTile(num5, num6, point.X, true, false, -1, point.Y);
              break;
          }
        }
      }
    ...
    private void PlaceStairs()
    {
      foreach (Tuple<Point, Point> stairs in this.CreateStairsList())
      {
        ...
        WorldUtils.Gen(new Point(origin.X + (num == 1 ? 1 : -4), origin.Y - 1), (GenShape) new Shapes.Rectangle(4, 1), Actions.Chain((GenAction) new Actions.Clear(), (GenAction) new Actions.PlaceWall(this.WallType, true), (GenAction) new Actions.PlaceTile((ushort) 19, this.PlatformStyle), (GenAction) new Actions.SetFrames(true)));
      }
    }
    ...
    private void PlaceSupportBeams()
    {
      foreach (Microsoft.Xna.Framework.Rectangle supportBeam in this.CreateSupportBeamList())
      {
        ...
        {
          WorldUtils.Gen(new Point(supportBeam.X, supportBeam.Y), (GenShape) new Shapes.Rectangle(supportBeam.Width, supportBeam.Height), Actions.Chain((GenAction) new Actions.SetTileKeepWall(this.BeamType, false, true), (GenAction) new Actions.SetFrames(true)));
