  ...
  public class UICreativeInfiniteItemsDisplay : UIElement
  {
    ...
    private void research_OnUpdate(UIElement affectedElement)
    {
      if (!affectedElement.IsMouseHovering)
        return;
      Main.instance.MouseText(Language.GetTextValue("CreativePowers.ResearchButtonTooltip"), 0, (byte) 0, -1, -1, -1, -1, 0);
    }
    ...
    {
      Asset<Texture2D> asset = (Asset<Texture2D>) Main.Assets.Request<Texture2D>(assetPath, (AssetRequestMode) 1);
