...
namespace Terraria.GameContent.UI.Elements
{
  public class UIGenProgressBar : UIElement
  {
    ...
    public UIGenProgressBar()
    {
      if (Main.netMode != 2)
      {
        this._texOuterCorrupt = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/WorldGen/Outer_Corrupt", (AssetRequestMode) 1);
        this._texOuterCrimson = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/WorldGen/Outer_Crimson", (AssetRequestMode) 1);
        this._texOuterLower = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/WorldGen/Outer_Lower", (AssetRequestMode) 1);
      }
      this.Recalculate();
    }
