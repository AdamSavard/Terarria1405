...
namespace Terraria.GameContent.UI.Elements
{
  public class UIScrollbar : UIElement
  {
    ...
    public bool CanScroll
    {
      get
      {
        return (double) this._maxViewSize != (double) this._viewSize;
      }
    }
    ...
    public UIScrollbar()
    {
      ...
      this._texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Scrollbar", (AssetRequestMode) 1);
      this._innerTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/ScrollbarInner", (AssetRequestMode) 1);
      this.PaddingTop = 5f;
