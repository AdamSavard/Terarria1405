  ...
  public class UIPanel : UIElement
  {
    ...
    public UIPanel()
    {
      if (this._borderTexture == null)
        this._borderTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/PanelBorder", (AssetRequestMode) 1);
      if (this._backgroundTexture == null)
        this._backgroundTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/PanelBackground", (AssetRequestMode) 1);
