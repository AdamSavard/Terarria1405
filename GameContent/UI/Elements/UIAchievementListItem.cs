...
namespace Terraria.GameContent.UI.Elements
{
  public class UIAchievementListItem : UIPanel
  {
    ...
    public UIAchievementListItem(Achievement achievement, bool largeForOtherLanguages)
    {
      ...
      this._achievementIcon = new UIImageFramed((Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievements", (AssetRequestMode) 1), this._iconFrame);
      ...
      this._achievementIconBorders = new UIImage((Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievement_Borders", (AssetRequestMode) 1));
      ...
      this._innerPanelTopTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievement_InnerPanelTop", (AssetRequestMode) 1);
      this._innerPanelBottomTexture = !this._large ? (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievement_InnerPanelBottom", (AssetRequestMode) 1) : (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievement_InnerPanelBottom_Large", (AssetRequestMode) 1);
      this._categoryTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievement_Categories", (AssetRequestMode) 1);
    }
