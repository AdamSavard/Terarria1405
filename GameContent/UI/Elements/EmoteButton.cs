...
namespace Terraria.GameContent.UI.Elements
{
  public class EmoteButton : UIElement
  {
    ...
    {
      this._texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Extra_" + (object) (short) 48, (AssetRequestMode) 1);
      this._textureBorder = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/EmoteBubbleBorder", (AssetRequestMode) 1);
    ...
    {
      return this._texture.Frame(8, 38, this._emoteIndex % 4 * 2 + (this._frameCounter >= 10 ? 1 : 0), this._emoteIndex / 4 + 1, 0, 0);
    }
    ...
    protected override void DrawSelf(SpriteBatch spriteBatch)
    {
      ...
      Main.instance.MouseText(cursorText, 0, (byte) 0, -1, -1, -1, -1, 0);
    }
