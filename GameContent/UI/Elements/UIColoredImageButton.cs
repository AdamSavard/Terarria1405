...
namespace Terraria.GameContent.UI.Elements
{
  public class UIColoredImageButton : UIElement
  {
    ...
    public UIColoredImageButton(Asset<Texture2D> texture, bool isSmall = false)
    {
      ...
      this._backPanelTexture = !isSmall ? (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/CharCreation/CategoryPanel", (AssetRequestMode) 1) : (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/CharCreation/SmallPanel", (AssetRequestMode) 1);
      this.Width.Set((float) this._backPanelTexture.Width(), 0.0f);
      this.Height.Set((float) this._backPanelTexture.Height(), 0.0f);
      this._backPanelHighlightTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/CharCreation/CategoryPanelHighlight", (AssetRequestMode) 1);
      if (isSmall)
        this._backPanelBorderTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/CharCreation/SmallPanelBorder", (AssetRequestMode) 1);
      else
        this._backPanelBorderTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/CharCreation/CategoryPanelBorder", (AssetRequestMode) 1);
    }
