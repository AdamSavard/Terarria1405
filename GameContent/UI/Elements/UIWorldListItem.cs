  ...
  public class UIWorldListItem : UIPanel
  {
    ...
    public UIWorldListItem(WorldFileData data, int orderInList, bool canBePlayed)
    {
      ...
      if (SocialAPI.Cloud != null)
      {
        ...
        uiImageButton3.SetSnapPoint("Cloud", orderInList, new Vector2?(), new Vector2?());
      ...
      if (this._data.WorldGeneratorVersion != 0UL)
      {
        ...
        uiImageButton3.OnMouseOut += new UIElement.MouseEvent(this.ButtonMouseOut);
        uiImageButton3.SetSnapPoint("Seed", orderInList, new Vector2?(), new Vector2?());
        this.Append((UIElement) uiImageButton3);
        pixels3 += 24f;
      }
      ...
      uiImageButton1.SetSnapPoint("Play", orderInList, new Vector2?(), new Vector2?());
      uiImageButton2.SetSnapPoint("Favorite", orderInList, new Vector2?(), new Vector2?());
      uiImageButton4.SetSnapPoint("Delete", orderInList, new Vector2?(), new Vector2?());
    }
    ...
    private void LoadTextures()
    {
      ...
      this._buttonSeedTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/ButtonSeed", (AssetRequestMode) 1);
    ...
    {
      this._buttonLabel.SetText(Language.GetTextValue("UI.CopySeed", (object) this._data.GetFullSeedText()));
    }
