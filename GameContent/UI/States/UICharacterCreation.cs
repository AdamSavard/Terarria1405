...
namespace Terraria.GameContent.UI.States
{
  public class UICharacterCreation : UIState
  {
    ...
    private void MakeHairsylesMenu(UIElement middleInnerPanel)
    {
      ...
      {
        UIHairStyleButton uiHairStyleButton1 = new UIHairStyleButton(this._player, Main.Hairstyles.AvailableHairstyles[id]);
        uiHairStyleButton1.Left = StyleDimension.FromPixels((float) ((double) (id % 10) * 46.0 + 6.0));
        uiHairStyleButton1.Top = StyleDimension.FromPixels((float) ((double) (id / 10) * 48.0 + 1.0));
        UIHairStyleButton uiHairStyleButton2 = uiHairStyleButton1;
        uiHairStyleButton2.SetSnapPoint("Middle", id, new Vector2?(), new Vector2?());
    ...
    private void MakeCategoriesBar(UIElement categoryContainer)
    {
      ...
      this._colorPickers[4].SetMiddleTexture((Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/CharCreation/ColorEyeBack", (AssetRequestMode) 1));
      ...
      this._clothingStylesCategoryButton.SetSnapPoint("Top", 1, new Vector2?(), new Vector2?());
      ...
      this._hairStylesCategoryButton.SetMiddleTexture((Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/CharCreation/HairStyle_Arrow", (AssetRequestMode) 1));
      this._hairStylesCategoryButton.SetSnapPoint("Top", 2, new Vector2?(), new Vector2?());
      ...
      this._charInfoCategoryButton.SetSnapPoint("Top", 0, new Vector2?(), new Vector2?());
      ...
      int num = 21;
      UIText uiText1 = new UIText(PlayerInput.GenerateInputTag_ForCurrentGamemode(false, "HotbarMinus"), 1f, false);
      ...
      UIText uiText3 = new UIText(PlayerInput.GenerateInputTag_ForCurrentGamemode(false, "HotbarMinus"), 1f, false);
      uiText3.HAlign = 1f;
    ...
    {
      UIColoredImageButton coloredImageButton = new UIColoredImageButton((Asset<Texture2D>) Main.Assets.Request<Texture2D>(texturePath, (AssetRequestMode) 1), false);
      ...
      coloredImageButton.SetSnapPoint("Top", (int) id, new Vector2?(), new Vector2?());
    ...
    private void MakeInfoMenu(UIElement parentContainer)
    {
      ...
      UICharacterNameButton characterNameButton = new UICharacterNameButton(Language.GetText("UI.WorldCreationName"), Language.GetText("UI.PlayerEmptyName"), (LocalizedText) null);
      ...
      characterNameButton.SetSnapPoint("Middle", 0, new Vector2?(), new Vector2?());
      float num1 = 4f;
      float num2 = 0.0f;
      float percent = 0.4f;
      UIElement element2 = new UIElement()
      ...
      UIText uiText1 = new UIText(Lang.menu[26], 1f, false);
      uiText1.HAlign = 0.0f;
      uiText1.VAlign = 0.5f;
      ...
      difficultyButton2.SetSnapPoint("Middle", 1, new Vector2?(), new Vector2?());
      difficultyButton4.SetSnapPoint("Middle", 2, new Vector2?(), new Vector2?());
      difficultyButton6.SetSnapPoint("Middle", 3, new Vector2?(), new Vector2?());
      difficultyButton8.SetSnapPoint("Middle", 4, new Vector2?(), new Vector2?());
    }
    ...
    private void MakeHSLMenu(UIElement parentContainer)
    {
      ...
      UIText uiText1 = new UIText("FFFFFF", 1f, false);
      uiText1.VAlign = 0.5f;
      uiText1.HAlign = 0.5f;
      UIText uiText2 = uiText1;
      ...
      coloredImageButton2.SetSnapPoint("Low", 0, new Vector2?(), new Vector2?());
      coloredImageButton4.SetSnapPoint("Low", 1, new Vector2?(), new Vector2?());
      coloredImageButton6.SetSnapPoint("Low", 2, new Vector2?(), new Vector2?());
    }
    ...
    private UIColoredSlider CreateHSLSlider(UICharacterCreation.HSLSliderId id)
    {
      ...
      sliderButtonBase.SetSnapPoint("Middle", (int) id, new Vector2?(), new Vector2?(new Vector2(0.0f, 20f)));
    ...
    {
      this._clothingStylesCategoryButton.SetImage((Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/CharCreation/" + (this._player.Male ? "ClothStyleMale" : "ClothStyleFemale"), (AssetRequestMode) 1));
      this.UpdateSelectedGender();
    }
    ...
    private void Click_CopyPlayerTemplate(UIMouseEvent evt, UIElement listeningElement)
    {
      ...
      dictionary.Add("version", (object) 1);
      dictionary.Add("hairStyle", (object) this._player.hair);
      dictionary.Add("clothingStyle", (object) this._player.skinVariant);
      dictionary.Add("hairColor", (object) UICharacterCreation.GetHexText(this._player.hairColor));
      dictionary.Add("eyeColor", (object) UICharacterCreation.GetHexText(this._player.eyeColor));
      dictionary.Add("skinColor", (object) UICharacterCreation.GetHexText(this._player.skinColor));
      dictionary.Add("shirtColor", (object) UICharacterCreation.GetHexText(this._player.shirtColor));
      dictionary.Add("underShirtColor", (object) UICharacterCreation.GetHexText(this._player.underShirtColor));
    ...
    private void Click_PastePlayerTemplate(UIMouseEvent evt, UIElement listeningElement)
    {
      ...
      try
      {
        ...
        if (num1 == -1)
          return;
        Dictionary<string, object> dictionary1 = (Dictionary<string, object>) JsonConvert.DeserializeObject<Dictionary<string, object>>(str2.Substring(0, num1 + 1));
        if (dictionary1 == null)
          return;
        ...
        {
          int num3 = (int) (long) obj;
          if (((IEnumerable<int>) this._validClothStyles).Contains<int>(num3))
            this._player.skinVariant = num3;
        }
        Vector3 hsl;
    ...
    private void Click_Naming(UIMouseEvent evt, UIElement listeningElement)
    {
      ...
      this._player.name = "";
      Main.clrInput();
      UIVirtualKeyboard uiVirtualKeyboard = new UIVirtualKeyboard(Lang.menu[45].Value, "", new UIVirtualKeyboard.KeyboardSubmitEvent(this.OnFinishedNaming), new Action(this.OnCancledNaming), 0, true);
    ...
    private void Click_NamingAndCreating(UIMouseEvent evt, UIElement listeningElement)
    {
      ...
      if (string.IsNullOrEmpty(this._player.name))
      {
        this._player.name = "";
        Main.clrInput();
        UIVirtualKeyboard uiVirtualKeyboard = new UIVirtualKeyboard(Lang.menu[45].Value, "", new UIVirtualKeyboard.KeyboardSubmitEvent(this.OnFinishedNamingAndCreating), new Action(this.OnCancledNaming), 0, false);
        uiVirtualKeyboard.SetMaxInputLength(20);
        Main.MenuUI.SetState((UIState) uiVirtualKeyboard);
      }
      else
    ...
    private void SetupPlayerStatsAndInventoryBasedOnDifficulty()
    {
      ...
      else
      {
        ...
        int index3 = index2 + 1;
        inventory1[index2].Prefix(-1);
        this._player.inventory[index3].SetDefaults(3509);
        Item[] inventory2 = this._player.inventory;
        int index4 = index3;
        int index5 = index4 + 1;
        inventory2[index4].Prefix(-1);
        this._player.inventory[index5].SetDefaults(3506);
        Item[] inventory3 = this._player.inventory;
        int index6 = index5;
        num1 = index6 + 1;
        inventory3[index6].Prefix(-1);
      ...
      if (Main.runningCollectorsEdition)
      {
        ...
        int index2 = num1;
        int num2 = index2 + 1;
        inventory[index2].SetDefaults(603);
      }
    ...
    private void SetupGamepadPoints(SpriteBatch spriteBatch)
    {
      ...
      for (int index = 0; index < list1.Count; ++index)
      {
        ...
        point3.Unlink();
        UILinkPointNavigator.SetPosition(ID3, list1[index].Position);
        point3.Left = ID3 - 1;
        point3.Right = ID3 + 1;
        point3.Down = num2;
        if (index == 0)
    ...
    {
      return Main.hslToRgb(hue, saturation, (float) ((double) luminosity * 0.850000023841858 + 0.150000005960464));
    }
