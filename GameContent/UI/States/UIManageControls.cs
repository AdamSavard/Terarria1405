...
namespace Terraria.GameContent.UI.States
{
  public class UIManageControls : UIState
  {
    ...
    {
      this._KeyboardGamepadTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Settings_Inputs", (AssetRequestMode) 1);
      this._keyboardGamepadBorderTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Settings_Inputs_Border", (AssetRequestMode) 1);
      this._GameplayVsUITexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Settings_Inputs_2", (AssetRequestMode) 1);
      this._GameplayVsUIBorderTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Settings_Inputs_2_Border", (AssetRequestMode) 1);
      ...
      switch (bind)
      {
        ...
        case "sp19":
          ...
          }), (Func<float>) (() => Utils.GetLerpValue(4f, 12f, (float) PlayerInput.CurrentProfile.InventoryMoveCD, true)), (Action<float>) (f => PlayerInput.CurrentProfile.InventoryMoveCD = (int) Math.Round((double) MathHelper.Lerp(4f, 12f, f))), (Action) (() =>
          {
            ...
            float num = UILinksInitializer.HandleSliderHorizontalInput(lerpValue, 0.0f, 1f, PlayerInput.CurrentProfile.InterfaceDeadzoneX, 0.5f);
