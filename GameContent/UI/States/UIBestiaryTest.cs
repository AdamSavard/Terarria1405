...
namespace Terraria.GameContent.UI.States
{
  public class UIBestiaryTest : UIState
  {
    ...
    private void ShowStats_Completion(UIElement element)
    {
      ...
      Main.instance.MouseText(completionPercentText, 0, (byte) 0, -1, -1, -1, -1, 0);
    }
    ...
    {
      UIImageButton uiImageButton1 = new UIImageButton((Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Button_Back", (AssetRequestMode) 1));
      uiImageButton1.SetHoverImage((Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Button_Border", (AssetRequestMode) 1));
      uiImageButton1.SetVisibility(1f, 1f);
      uiImageButton1.SetSnapPoint("BackPage", 0, new Vector2?(), new Vector2?());
      this._entryGrid.MakeButtonGoByOffset((UIElement) uiImageButton1, -1);
      innerTopContainer.Append((UIElement) uiImageButton1);
      UIImageButton uiImageButton2 = new UIImageButton((Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Button_Forward", (AssetRequestMode) 1));
      uiImageButton2.Left = new StyleDimension(uiImageButton1.Width.Pixels + 1f, 0.0f);
      UIImageButton uiImageButton3 = uiImageButton2;
      uiImageButton3.SetHoverImage((Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Button_Border", (AssetRequestMode) 1));
      uiImageButton3.SetVisibility(1f, 1f);
      uiImageButton3.SetSnapPoint("NextPage", 0, new Vector2?(), new Vector2?());
      ...
      UIText uiText1 = new UIText("9000-9999 (9001)", 0.8f, false);
      uiText1.HAlign = 0.5f;
      uiText1.VAlign = 0.5f;
    ...
    {
      this._searchBar.SetContents(name.Trim(), false);
      this.GoBackHere();
    }
    ...
    private void SetupGamepadPoints(SpriteBatch spriteBatch)
    {
      ...
      else if (this._entryGrid.Parent != null)
      {
        ...
        for (int index = 0; index < gridWidth; ++index)
        {
          ...
          if (downSide2 != null)
          {
            if (index < gridWidth / 2)
              this.PairUpDown(uiLinkPoint2, downSide2);
        ...
        UILinkPoint downSide3 = gridPoints[0, 0];
        if (downSide3 != null)
        {
          this.PairUpDown(uiLinkPoint2, downSide3);
          this.PairUpDown(uiLinkPoint1, downSide3);
        }
        else
        {
          this.PairUpDown(uiLinkPoint2, downSide1);
      ...
      for (int index = num1; index < currentID; ++index)
        lostrefpoints.Add(UILinkPointNavigator.Points[index]);
