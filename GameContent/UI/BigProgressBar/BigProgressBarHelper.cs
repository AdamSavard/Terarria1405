...
namespace Terraria.GameContent.UI.BigProgressBar
{
  public class BigProgressBarHelper
  {
      ...
      float shieldPercent)
    {
      ...
      Rectangle rectangle4 = texture2D.Frame(1, verticalFrames, 0, 5, 0, 0);
      rectangle4.X += p2.X;
      rectangle4.Y += p2.Y;
      rectangle4.Width = 2;
      rectangle4.Height = p1.Y;
      Rectangle rectangle5 = texture2D.Frame(1, verticalFrames, 0, 4, 0, 0);
      rectangle5.X += p2.X;
      rectangle5.Y += p2.Y;
      rectangle5.Width = 2;
      ...
      Rectangle rectangle6 = texture2D.Frame(1, verticalFrames, 0, 0, 0, 0);
