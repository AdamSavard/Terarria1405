...
namespace Terraria.GameContent.Golf
{
  public class FancyGolfPredictionLine
  {
    ...
    {
      return (float) (0.200000002980232 + (double) Utils.GetLerpValue(0.8f, 1f, (float) (Math.Cos((double) travelledLength / 50.0 + (double) this._time * -3.14159274101257) * 0.5 + 0.5), true) * 0.150000005960464);
    }
