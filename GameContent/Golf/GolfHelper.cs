...
namespace Terraria.GameContent.Golf
{
  public static class GolfHelper
  {
    ...
    {
      return (double) Math.Abs(radius.X) < 9.99999974737875E-05 || (double) Math.Abs(radius.Y) < 9.99999974737875E-05 ? Vector2.Zero : Vector2.Normalize(vector / radius) * radius;
    }
    ...
    public class ContactListener : IBallContactListener
    {
      ...
      private static void EmitGolfballExplosion(Vector2 Center)
      {
        ...
        {
          Dust dust = Dust.NewDustPerfect(Center, 278, new Vector2?((num * 6.283185f).ToRotationVector2() * new Vector2(2f, 0.5f)), 0, new Color(), 1f);
          dust.fadeIn = 1.2f;
          dust.noGravity = true;
        ...
        for (int index1 = 0; (double) index1 < (double) num2; ++index1)
        {
          ...
          {
            Dust dust = Dust.NewDustPerfect(Center + new Vector2((float) index1 - num2 / 2f, 0.0f) * 2f, 278, new Vector2?(vector2), 0, new Color(), 1f);
            dust.fadeIn = 0.7f;
            dust.scale = 0.7f;
            dust.noGravity = true;
            dust.position.Y += -1f;
        ...
        for (float num3 = 0.0f; (double) num3 < 1.0; num3 += 0.2f)
        {
          Dust dust = Dust.NewDustPerfect(Center, 278, new Vector2?((num3 * 6.283185f).ToRotationVector2() * new Vector2(1f, 0.5f)), 0, new Color(), 1f);
          dust.fadeIn = 1.2f;
          dust.noGravity = true;
          dust.velocity.X *= 0.7f;
        ...
        for (float num3 = 0.0f; (double) num3 < 1.0; num3 += 0.15f)
        {
          Dust dust = Dust.NewDustPerfect(Center, 278, new Vector2?((num4 + num3 * 6.283185f).ToRotationVector2() * 4f), 0, new Color(), 1f);
          dust.fadeIn = 1.5f;
          dust.velocity *= (float) (0.5 + (double) num3 * 0.800000011920929);
          dust.noGravity = true;
      ...
      private static void EmitGolfballExplosion_v1(Vector2 Center)
      {
        ...
        {
          Dust dust = Dust.NewDustPerfect(Center, 278, new Vector2?((num * 6.283185f).ToRotationVector2() * new Vector2(1f, 0.5f)), 0, new Color(), 1f);
          dust.fadeIn = 1.2f;
          dust.noGravity = true;
          dust.velocity.X *= 0.7f;
          dust.velocity.Y -= 0.5f;
        ...
        {
          Dust dust = Dust.NewDustPerfect(Center, 278, new Vector2?((num1 + num2 * 6.283185f).ToRotationVector2() * 4f), 0, new Color(), 1f);
          dust.fadeIn = 1.5f;
