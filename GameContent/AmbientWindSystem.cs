...
namespace Terraria.GameContent
{
  public class AmbientWindSystem
  {
    ...
    private void SpawnAirborneCloud(int x, int y)
    {
      ...
      Vector2 worldCoordinates = new Point(x, y).ToWorldCoordinates(8f, 8f);
      ...
      for (int index = 0; index < num1; ++index)
      {
        ...
        Vector2 vector2_3 = Vector2.UnitX.RotatedBy((double) num8, new Vector2()) * num7;
    ...
    {
      Vector2 worldCoordinates = new Point(x, y - 1).ToWorldCoordinates(8f, 8f);
