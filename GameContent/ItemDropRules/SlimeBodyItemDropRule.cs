...
namespace Terraria.GameContent.ItemDropRules
{
  public class SlimeBodyItemDropRule : IItemDropRule
  {
    ...
    {
      return info.npc.type == 1 && (double) info.npc.ai[1] > 0.0 && (double) info.npc.ai[1] < 5045.0;
    }
    ...
    public ItemDropAttemptResult TryDroppingItem(DropAttemptInfo info)
    {
      ...
      CommonCode.DropItemFromNPC(info.npc, itemId, info.rng.Next(amountDroppedMinimum, amountDroppedMaximum + 1), false);
