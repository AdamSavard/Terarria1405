  ...
  public static class CommonConditions
  {
    ...
    public static class UndergroundBiome
    {
      ...
      private static bool InTemple(Player player)
      {
        ...
        return WorldGen.InWorld(x, y, 0) && Main.tile[x, y] != null && Main.tile[x, y].wall == (ushort) 87;
      }
    ...
    public static class Depth
    {
      ...
      private static bool IsPlayerInFrontOfDirtWall(Player player)
      {
        ...
        if (!WorldGen.InWorld(tileCoordinates.X, tileCoordinates.Y, 0) || Main.tile[tileCoordinates.X, tileCoordinates.Y] == null)
          return false;
