  ...
  public class SmartCursorHelper
  {
      ...
      ref int focusedY)
    {
      ...
      if (SmartCursorHelper._targets.Count > 0)
      {
        ...
        for (int index = 0; index < SmartCursorHelper._targets.Count; ++index)
        {
          if (Collision.EmptyTile(SmartCursorHelper._targets[index].Item1, SmartCursorHelper._targets[index].Item2, false))
          {
            float num2 = Vector2.Distance(new Vector2((float) SmartCursorHelper._targets[index].Item1, (float) SmartCursorHelper._targets[index].Item2) * 16f + Vector2.One * 8f, providedInfo.mouse);
            if ((double) num1 == -1.0 || (double) num2 < (double) num1)
            {
      ...
      ref int focusedY)
    {
      ...
      if (providedInfo.item.hammer > 0 && focusedX == -1 && focusedY == -1)
      {
        ...
        if (num2 != 0)
        {
          for (int index3 = 0; index3 < num6; ++index3)
          {
            if (Main.tile[(int) ((double) providedInfo.position.X / 16.0) + index3, index2] != null)
              SmartCursorHelper._points.Add(new Tuple<int, int>((int) ((double) providedInfo.position.X / 16.0) + index3, index2));
          }
        }
        ...
        if (num1 != 0)
        {
          for (int index3 = 0; index3 < num9; ++index3)
          {
            if (Main.tile[index4, index5 + index3 * num5] != null)
              SmartCursorHelper._endpoints.Add(new Tuple<int, int>(index4, index5 + index3 * num5));
          }
        }
        if (num2 != 0)
        {
          for (int index3 = 0; index3 < num8; ++index3)
          {
            if (Main.tile[(int) (((double) providedInfo.mouse.X - (double) (width / 2)) / 16.0) + index3, index5] != null)
              SmartCursorHelper._endpoints.Add(new Tuple<int, int>((int) (((double) providedInfo.mouse.X - (double) (width / 2)) / 16.0) + index3, index5));
          }
        }
        SmartCursorHelper._targets.Clear();
        ...
        if (SmartCursorHelper._targets.Count > 0)
        {
          ...
          for (int index3 = 0; index3 < SmartCursorHelper._targets.Count; ++index3)
          {
            if (!Main.tile[SmartCursorHelper._targets[index3].Item1, SmartCursorHelper._targets[index3].Item2].active() || Main.tile[SmartCursorHelper._targets[index3].Item1, SmartCursorHelper._targets[index3].Item2].type != (ushort) 26)
            {
              float num11 = Vector2.Distance(new Vector2((float) SmartCursorHelper._targets[index3].Item1, (float) SmartCursorHelper._targets[index3].Item2) * 16f + Vector2.One * 8f, providedInfo.Center);
              if ((double) num10 == -1.0 || (double) num11 < (double) num10)
              {
                num10 = num11;
                tuple = SmartCursorHelper._targets[index3];
              }
            }
          }
      ...
      ref int fY)
    {
      ...
      if (SmartCursorHelper._targets.Count > 0)
      {
        ...
        for (int index = 0; index < SmartCursorHelper._targets.Count; ++index)
        {
          float num4 = Vector2.Distance(new Vector2((float) SmartCursorHelper._targets[index].Item1, (float) SmartCursorHelper._targets[index].Item2) * 16f + Vector2.One * 8f, mouse);
          if ((double) num3 == -1.0 || (double) num4 < (double) num3)
          {
            num3 = num4;
            target = SmartCursorHelper._targets[index];
      ...
      ref int focusedY)
    {
      ...
      if (num2 != 0)
      {
        for (int index3 = 0; index3 < num6; ++index3)
        {
          if (Main.tile[(int) ((double) position.X / 16.0) + index3, index2] != null)
            SmartCursorHelper._points.Add(new Tuple<int, int>((int) ((double) position.X / 16.0) + index3, index2));
        }
      }
        ...
        if (num1 != 0)
        {
          for (int index3 = 0; index3 < num9; ++index3)
          {
            if (Main.tile[x, y + index3 * num5] != null)
              SmartCursorHelper._endpoints.Add(new Tuple<int, int>(x, y + index3 * num5));
          }
        }
        if (num2 != 0)
        {
          for (int index3 = 0; index3 < num8; ++index3)
          {
            if (Main.tile[(int) (((double) providedInfo.mouse.X - (double) (width / 2)) / 16.0) + index3, y] != null)
              SmartCursorHelper._endpoints.Add(new Tuple<int, int>((int) (((double) providedInfo.mouse.X - (double) (width / 2)) / 16.0) + index3, y));
          }
        }
      }
      SmartCursorHelper._targets.Clear();
      ...
      for (int index3 = 0; index3 < SmartCursorHelper._targets.Count; ++index3)
      {
        if (!WorldGen.CanKillTile(SmartCursorHelper._targets[index3].Item1, SmartCursorHelper._targets[index3].Item2))
          SmartCursorHelper._toRemove.Add(SmartCursorHelper._targets[index3]);
      }
      for (int index3 = 0; index3 < SmartCursorHelper._toRemove.Count; ++index3)
        SmartCursorHelper._targets.Remove(SmartCursorHelper._toRemove[index3]);
      SmartCursorHelper._toRemove.Clear();
      if (SmartCursorHelper._targets.Count > 0)
      {
        float num10 = -1f;
        ...
        for (int index3 = 0; index3 < SmartCursorHelper._targets.Count; ++index3)
        {
          float num11 = Vector2.Distance(new Vector2((float) SmartCursorHelper._targets[index3].Item1, (float) SmartCursorHelper._targets[index3].Item2) * 16f + Vector2.One * 8f, vector2_2);
          if ((double) num10 == -1.0 || (double) num11 < (double) num10)
          {
            num10 = num11;
            target = SmartCursorHelper._targets[index3];
          }
        }
        if (Collision.InTileBounds(target.Item1, target.Item2, providedInfo.reachableStartX, providedInfo.reachableStartY, providedInfo.reachableEndX, providedInfo.reachableEndY))
        {
