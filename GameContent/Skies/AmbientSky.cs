...
namespace Terraria.GameContent.Skies
{
  public class AmbientSky : CustomSky
  {
    ...
    public override void Update(GameTime gameTime)
    {
      ...
      using (IEnumerator<SlotVector<AmbientSky.SkyEntity>.ItemPair> enumerator = ((IEnumerable<SlotVector<AmbientSky.SkyEntity>.ItemPair>) this._entities).GetEnumerator())
      {
    ...
    public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
    {
      ...
      {
        while (((IEnumerator) enumerator).MoveNext())
          ((AmbientSky.SkyEntity) enumerator.Current.Value).Draw(spriteBatch, 3f, minDepth, maxDepth);
      }
    }
    ...
    private class ButterfliesSkyEntity : AmbientSky.FadingSkyEntity
    {
      public ButterfliesSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/ButterflySwarm" + (object) num2, (AssetRequestMode) 1);
      ...
      {
        this.Velocity = new Vector2((float) ((0.100000001490116 + (double) Math.Abs(Main.WindForVisuals) * 0.0500000007450581) * (this.Effects == SpriteEffects.FlipHorizontally ? -1.0 : 1.0)), 0.0f);
      }
    ...
    private class LostKiteSkyEntity : AmbientSky.FadingSkyEntity
    {
      public LostKiteSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 3.0);
        this.SetPositionInWorldBasedOnScreenSpace(this.Position);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/LostKite", (AssetRequestMode) 1);
    ...
    private class PegasusSkyEntity : AmbientSky.FadingSkyEntity
    {
      public PegasusSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 3.0);
        this.SetPositionInWorldBasedOnScreenSpace(this.Position);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Pegasus", (AssetRequestMode) 1);
      ...
      public override void UpdateVelocity(int frameCount)
      {
        this.Velocity = new Vector2((float) ((1.5 + (double) Math.Abs(Main.WindForVisuals) * 0.600000023841858) * (this.Effects == SpriteEffects.FlipHorizontally ? -1.0 : 1.0)), 0.0f);
      }
    ...
    private class VultureSkyEntity : AmbientSky.FadingSkyEntity
    {
      public VultureSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 3.0);
        this.SetPositionInWorldBasedOnScreenSpace(this.Position);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Vulture", (AssetRequestMode) 1);
    ...
    private class PixiePosseSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public PixiePosseSkyEntity(Player player, FastRandom random)
      {
        ...
        if (!Main.dayTime)
          this.pixieType = 2;
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/PixiePosse" + (object) this.pixieType, (AssetRequestMode) 1);
      ...
      public override void UpdateVelocity(int frameCount)
      {
        this.Velocity = new Vector2((float) ((0.119999997317791 + (double) Math.Abs(Main.WindForVisuals) * 0.0799999982118607) * (this.Effects == SpriteEffects.FlipHorizontally ? -1.0 : 1.0)), 0.0f);
      }
    ...
    private class BirdsPackSkyEntity : AmbientSky.FadingSkyEntity
    {
      public BirdsPackSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 3.0);
        this.SetPositionInWorldBasedOnScreenSpace(this.Position);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/BirdsVShape", (AssetRequestMode) 1);
    ...
    private class SeagullsGroupSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public SeagullsGroupSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 3.0);
        this.SetPositionInWorldBasedOnScreenSpace(this.Position);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Seagull", (AssetRequestMode) 1);
    ...
    private class GastropodGroupSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public GastropodGroupSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 2.0);
        this.SetPositionInWorldBasedOnScreenSpace(this.Position);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Gastropod", (AssetRequestMode) 1);
    ...
    private class SlimeBalloonGroupSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public SlimeBalloonGroupSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 3.0);
        this.SetPositionInWorldBasedOnScreenSpace(this.Position);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/SlimeBalloons", (AssetRequestMode) 1);
    ...
    private class HellBatsGoupSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public HellBatsGoupSkyEntity(Player player, FastRandom random)
      {
        ...
        this.SetPositionInWorldBasedOnScreenSpace(this.Position);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/HellBat" + (object) random.Next(1, 3), (AssetRequestMode) 1);
        this.Frame = new SpriteFrame((byte) 1, (byte) 10);
        this.LifeTime = random.Next(60, 121) * 60;
        this.OpacityNormalizedTimeToFadeIn = 0.1f;
        this.OpacityNormalizedTimeToFadeOut = 0.9f;
      ...
      public override Color GetColor(Color backgroundColor)
      {
        return Color.Lerp(Color.White, Color.Gray, this.Depth / 15f) * this.Opacity * this.FinalOpacityMultiplier;
      }
    ...
    private class BatsGroupSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public BatsGroupSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 3.0);
        this.SetPositionInWorldBasedOnScreenSpace(this.Position);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Bat" + (object) random.Next(1, 4), (AssetRequestMode) 1);
        this.Frame = new SpriteFrame((byte) 1, (byte) 10);
        this.LifeTime = random.Next(60, 121) * 60;
        this.OpacityNormalizedTimeToFadeIn = 0.1f;
        this.OpacityNormalizedTimeToFadeOut = 0.9f;
    ...
    private class WyvernSkyEntity : AmbientSky.FadingSkyEntity
    {
      public WyvernSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 3.0);
        this.SetPositionInWorldBasedOnScreenSpace(this.Position);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Wyvern", (AssetRequestMode) 1);
    ...
    private class AirshipSkyEntity : AmbientSky.FadingSkyEntity
    {
      public AirshipSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 3.0);
        this.SetPositionInWorldBasedOnScreenSpace(this.Position);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/FlyingShip", (AssetRequestMode) 1);
        this.Frame = new SpriteFrame((byte) 1, (byte) 4);
        this.LifeTime = random.Next(40, 71) * 60;
      ...
      public override void UpdateVelocity(int frameCount)
      {
        this.Velocity = new Vector2((float) ((6.0 + (double) Math.Abs(Main.WindForVisuals) * 1.60000002384186) * (this.Effects == SpriteEffects.FlipHorizontally ? -1.0 : 1.0)), 0.0f);
      }
    ...
    private class AirBalloonSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public AirBalloonSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 3.0);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/AirBalloons_" + (random.Next(2) == 0 ? "Large" : "Small"), (AssetRequestMode) 1);
        this.Frame = new SpriteFrame((byte) 1, (byte) 5);
    ...
    private class CrimeraSkyEntity : AmbientSky.EOCSkyEntity
    {
        ...
        : base(player, random)
      {
        ...
        if ((double) this.Depth <= 5.0)
          num = 1;
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Crimera" + (object) num, (AssetRequestMode) 1);
    ...
    private class EOSSkyEntity : AmbientSky.EOCSkyEntity
    {
        ...
        : base(player, random)
      {
        ...
        if ((double) this.Depth <= 5.0)
          num = 1;
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/EOS" + (object) num, (AssetRequestMode) 1);
        this.Frame = new SpriteFrame((byte) 1, (byte) 4);
      }
    ...
    private class EOCSkyEntity : AmbientSky.FadingSkyEntity
    {
      ...
      public EOCSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/EOC", (AssetRequestMode) 1);
        this.Frame = new SpriteFrame((byte) 1, (byte) 3);
      ...
      {
        this.Velocity = new Vector2((float) (this._direction * 3), (float) Math.Cos((double) frameCount / 1200.0 * 6.28318548202515) * this._waviness);
      }
    ...
    private class MeteorSkyEntity : AmbientSky.FadingSkyEntity
    {
      public MeteorSkyEntity(Player player, FastRandom random)
      {
        ...
        this.Effects = random.Next(2) == 0 ? SpriteEffects.None : SpriteEffects.FlipHorizontally;
        this.Depth = (float) ((double) random.NextFloat() * 3.0 + 3.0);
        this.Texture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/Backgrounds/Ambience/Meteor", (AssetRequestMode) 1);
        this.Frame = new SpriteFrame((byte) 1, (byte) 4);
