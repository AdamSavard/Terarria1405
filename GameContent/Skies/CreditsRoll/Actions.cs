...
namespace Terraria.GameContent.Skies.CreditsRoll
{
  public class Actions
  {
    ...
    public class Sprites
    {
      ...
      public class Fade : Actions.Sprites.ISpriteAction, ICreditsRollSegmentAction<Segments.LooseSprite>
      {
        private int _duration;
      ...
      public class Wait : Actions.Sprites.ISpriteAction, ICreditsRollSegmentAction<Segments.LooseSprite>
      {
        private int _duration;
        private float _delay;
