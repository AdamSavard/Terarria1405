...
namespace Terraria.GameContent.Creative
{
  public class CreativeUI
  {
    ...
    {
      this._buttonTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Creative/Journey_Toggle", (AssetRequestMode) 1);
      this._buttonBorderTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Creative/Journey_Toggle_MouseOver", (AssetRequestMode) 1);
