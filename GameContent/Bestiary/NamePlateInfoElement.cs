...
namespace Terraria.GameContent.Bestiary
{
  public class NamePlateInfoElement : IBestiaryInfoElement, IProvideSearchFilterString
  {
    ...
    {
      UIElement element = info.UnlockState != BestiaryEntryUnlockState.NotKnownAtAll_0 ? (UIElement) new UIText(Language.GetText(this._key), 1f, false) : (UIElement) new UIText("???", 1f, false);
      element.HAlign = 0.5f;
      element.VAlign = 0.5f;
