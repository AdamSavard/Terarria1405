...
namespace Terraria.GameContent.Bestiary
{
  public class NPCPortraitInfoElement : IBestiaryInfoElement
  {
    ...
    private UIElement CreateStarsContainer()
    {
      ...
      UIPanel uiPanel = new UIPanel((Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Bestiary/Stat_Panel", (AssetRequestMode) 1), (Asset<Texture2D>) null, 5, 21);
      ...
      for (int index = val2 - 1; index >= 0; --index)
      {
        ...
        UIImage uiImage1 = new UIImage((Asset<Texture2D>) Main.Assets.Request<Texture2D>(str, (AssetRequestMode) 1));
