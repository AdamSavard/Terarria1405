...
namespace Terraria.Social.WeGame
{
  public class NetServerSocialModule : NetSocialModule
  {
    ...
    {
      return this._connectionStateMap.ContainsKey(user) && (uint) this._connectionStateMap[user] > 0U;
    }
    ...
    {
      return (ulong) ((RailComparableID) this._serverID).id_;
    }
