...
namespace Terraria
{
  public class Recipe
  {
      ...
      else
      {
        ...
        else
        {
          ...
          for (int index1 = 0; index1 < Recipe.maxRecipes && Main.recipe[index1].createItem.type != 0; ++index1)
          {
            ...
            if (flag1)
            {
              int num3 = !Main.recipe[index1].needWater || Main.player[Main.myPlayer].adjWater ? 1 : (Main.player[Main.myPlayer].adjTile[172] ? 1 : 0);
              ...
              bool flag5 = !Main.recipe[index1].needGraveyardBiome || Main.player[Main.myPlayer].ZoneGraveyard;
              int num4 = flag2 ? 1 : 0;
              if ((num3 & num4 & (flag3 ? 1 : 0) & (flag4 ? 1 : 0) & (flag5 ? 1 : 0)) == 0)
                flag1 = false;
            }
            if (flag1)
            {
    ...
    {
      return tileID == 26 && WorldGen.crimson ? 1 : 0;
    }
  }
}
