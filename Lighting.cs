...
namespace Terraria
{
  public class Lighting
  {
    ...
    public static void GetColor4Slice(int centerX, int centerY, ref Color[] slices)
    {
      ...
      {
        int num5 = (int) ((double) byte.MaxValue * (double) color1.X * (double) Lighting.GlobalBrightness);
        int num6 = (int) ((double) byte.MaxValue * (double) color1.Y * (double) Lighting.GlobalBrightness);
        int num7 = (int) ((double) byte.MaxValue * (double) color1.Z * (double) Lighting.GlobalBrightness);
        if (num5 > (int) byte.MaxValue)
          num5 = (int) byte.MaxValue;
        if (num6 > (int) byte.MaxValue)
          num6 = (int) byte.MaxValue;
      ...
      if (num1 >= (double) num3)
      {
        int num5 = (int) ((double) byte.MaxValue * (double) color4.X * (double) Lighting.GlobalBrightness);
        int num6 = (int) ((double) byte.MaxValue * (double) color4.Y * (double) Lighting.GlobalBrightness);
        int num7 = (int) ((double) byte.MaxValue * (double) color4.Z * (double) Lighting.GlobalBrightness);
        if (num5 > (int) byte.MaxValue)
          num5 = (int) byte.MaxValue;
        if (num6 > (int) byte.MaxValue)
          num6 = (int) byte.MaxValue;
      ...
      {
        int num5 = (int) ((double) byte.MaxValue * (double) color2.X * (double) Lighting.GlobalBrightness);
        int num6 = (int) ((double) byte.MaxValue * (double) color2.Y * (double) Lighting.GlobalBrightness);
        int num7 = (int) ((double) byte.MaxValue * (double) color2.Z * (double) Lighting.GlobalBrightness);
        if (num5 > (int) byte.MaxValue)
          num5 = (int) byte.MaxValue;
        if (num6 > (int) byte.MaxValue)
          num6 = (int) byte.MaxValue;
