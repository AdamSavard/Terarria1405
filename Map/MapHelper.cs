  ...
  public static class MapHelper
  {
    ...
    public static void Initialize()
    {
      ...
      for (int index = 0; index < colorArray5.Length; ++index)
      {
        ...
        float num2 = 1f - num1;
        colorArray5[index] = new Color((int) (byte) ((double) color6.R * (double) num2 + (double) color7.R * (double) num1), (int) (byte) ((double) color6.G * (double) num2 + (double) color7.G * (double) num1), (int) (byte) ((double) color6.B * (double) num2 + (double) color7.B * (double) num1));
      }
      ...
      for (int index = 0; index < colorArray6.Length; ++index)
      {
        float num1 = (float) index / (float) byte.MaxValue;
        float num2 = 1f - num1;
        colorArray6[index] = new Color((int) (byte) ((double) color8.R * (double) num2 + (double) color7.R * (double) num1), (int) (byte) ((double) color8.G * (double) num2 + (double) color7.G * (double) num1), (int) (byte) ((double) color8.B * (double) num2 + (double) color7.B * (double) num1));
      }
...
label_11:
      ...
      if (num3 == 0)
      {
        ...
        {
          int num4 = (int) (byte) ((double) byte.MaxValue * ((double) j / Main.worldSurface));
          num3 = (int) MapHelper.skyPosition + num4;
        ...
        else if (j < Main.UnderworldLayer)
        {
          ...
          if (((double) i < (double) num5 || (double) i > (double) num6 || ((double) j < (double) num7 || (double) j > (double) num8)) && (i > 40 && i < Main.maxTilesX - 40 && (j > 40 && j < Main.maxTilesY - 40)))
          {
            for (int index1 = i - 36; index1 <= i + 30; index1 += 10)
            {
              for (int index2 = j - 36; index2 <= j + 30; index2 += 10)
              {
                ...
                {
                  if ((int) MapHelper.snowTypes[index3] == type)
                  {
                    num4 = byte.MaxValue;
                    index1 = i + 31;
                    index2 = j + 31;
          ...
          num3 = (double) j >= Main.rockLayer ? (int) MapHelper.rockPosition + (int) num4 : (int) MapHelper.dirtPosition + (int) num4;
        }
        else
            ...
            for (int index2 = 0; index2 < Main.maxTilesY; ++index2)
            {
              ...
              for (int index3 = 0; index3 < Main.maxTilesX; index3 = num6 + 1)
              {
                ...
                if (mapTile.Light <= (byte) 18)
                {
                  ...
                  num13 = 0;
                  int index4 = index3 + 1;
                  for (int index5 = Main.maxTilesX - index3 - 1; index5 > 0 && Main.Map[index4, index2].Light <= (byte) 18; ++index4)
                  {
                    ++num13;
                    --index5;
                  }
                ...
                if (flag1 && num12 > (ushort) byte.MaxValue)
                  num15 |= (byte) 16;
                if (flag2)
                  num15 |= (byte) 32;
                if (num13 > 0)
