...
namespace Terraria.DataStructures
{
  public class PlayerDeathReason
  {
    ...
    public int? SourceProjectileType
    {
      get
      {
        return this._sourceProjectileIndex == -1 ? new int?() : new int?(this._sourceProjectileType);
      }
    }
    ...
    {
      return this._sourceCustomReason != null ? NetworkText.FromLiteral(this._sourceCustomReason) : Lang.CreateDeathMessage(deadPlayerName, this._sourcePlayerIndex, this._sourceNPCIndex, this._sourceProjectileIndex, this._sourceOtherIndex, this._sourceProjectileType, this._sourceItemType);
    }
