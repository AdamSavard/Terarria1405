  ...
  public struct PlayerDrawSet
  {
      ...
      Vector2 rotationOrigin)
    {
      ...
      else if (this.drawPlayer.head == 170)
      {
        ...
        byte num13 = (byte) (62.5 * (double) (1 + num10));
        this.headGlowColor = new Color((int) num13, (int) num13, (int) num13, 0);
      }
      else if (this.drawPlayer.head == 189)
      {
        this.headGlowMask = 184;
        byte num13 = (byte) (62.5 * (double) (1 + num12));
        this.headGlowColor = new Color((int) num13, (int) num13, (int) num13, 0);
        this.colorArmorHead = this.drawPlayer.GetImmuneAlphaPure(new Color((int) num13, (int) num13, (int) num13, (int) byte.MaxValue), this.shadow);
      }
      else if (this.drawPlayer.head == 171)
      {
        byte num13 = (byte) (62.5 * (double) (1 + num11));
        this.colorArmorHead = this.drawPlayer.GetImmuneAlphaPure(new Color((int) num13, (int) num13, (int) num13, (int) byte.MaxValue), this.shadow);
      }
      ...
      if (this.drawPlayer.body == 175)
      {
        ...
        byte num13 = (byte) (62.5 * (double) (1 + num9));
        this.bodyGlowColor = new Color((int) num13, (int) num13, (int) num13, 0);
      }
      ...
      else if (this.drawPlayer.body == 190)
      {
        ...
        byte num13 = (byte) (62.5 * (double) (1 + num12));
        this.bodyGlowColor = new Color((int) num13, (int) num13, (int) num13, 0);
        this.armGlowColor = new Color((int) num13, (int) num13, (int) num13, 0);
        this.colorArmorBody = this.drawPlayer.GetImmuneAlphaPure(new Color((int) num13, (int) num13, (int) num13, (int) byte.MaxValue), this.shadow);
      }
      ...
      if (this.drawPlayer.legs == 111)
      {
        ...
        byte num13 = (byte) (62.5 * (double) (1 + num10));
        this.legsGlowColor = new Color((int) num13, (int) num13, (int) num13, 0);
      }
      ...
      {
        byte num13 = (byte) (62.5 * (double) (1 + num11));
        this.colorArmorLegs = this.drawPlayer.GetImmuneAlphaPure(new Color((int) num13, (int) num13, (int) num13, (int) byte.MaxValue), this.shadow);
      }
      ...
      {
        byte num13 = (byte) ((int) sbyte.MaxValue * (1 + num12));
      ...
      if (!this.drawPlayer.isDisplayDollOrInanimate)
      {
        ...
        {
          float num13 = (float) ((double) Main.mouseTextColor / 200.0 - 0.300000011920929);
          if ((double) this.shadow != 0.0)
            num13 = 0.0f;
          this.colorArmorHead.R = (byte) ((double) this.colorArmorHead.R * (double) num13);
          this.colorArmorHead.G = (byte) ((double) this.colorArmorHead.G * (double) num13);
          this.colorArmorHead.B = (byte) ((double) this.colorArmorHead.B * (double) num13);
          this.colorArmorBody.R = (byte) ((double) this.colorArmorBody.R * (double) num13);
          this.colorArmorBody.G = (byte) ((double) this.colorArmorBody.G * (double) num13);
          this.colorArmorBody.B = (byte) ((double) this.colorArmorBody.B * (double) num13);
          this.colorArmorLegs.R = (byte) ((double) this.colorArmorLegs.R * (double) num13);
          this.colorArmorLegs.G = (byte) ((double) this.colorArmorLegs.G * (double) num13);
          this.colorArmorLegs.B = (byte) ((double) this.colorArmorLegs.B * (double) num13);
        }
        if (this.drawPlayer.head == 193 && this.drawPlayer.body == 194 && this.drawPlayer.legs == 134)
        {
          float num13 = (float) (0.600000023841858 - (double) this.drawPlayer.ghostFade * 0.300000011920929);
          if ((double) this.shadow != 0.0)
            num13 = 0.0f;
          this.colorArmorHead.R = (byte) ((double) this.colorArmorHead.R * (double) num13);
          this.colorArmorHead.G = (byte) ((double) this.colorArmorHead.G * (double) num13);
      ...
      {
        Dust dust1 = Dust.NewDustDirect(this.Position, this.drawPlayer.width, this.drawPlayer.height, 152, 0.0f, 0.0f, 150, new Color(), 1f);
      ...
      {
        Dust dust1 = Dust.NewDustDirect(new Vector2(this.drawPlayer.position.X - 2f, (float) ((double) this.drawPlayer.position.Y + (double) this.drawPlayer.height - 2.0)), this.drawPlayer.width + 4, 4, 163, 0.0f, 0.0f, 100, new Color(), 1.5f);
        dust1.noGravity = true;
        dust1.noLight = true;
        dust1.velocity *= 0.0f;
        this.DustCache.Add(dust1.dustIndex);
      ...
      if (this.drawPlayer.poisoned)
      {
        ...
        {
          Dust dust1 = Dust.NewDustDirect(this.Position, this.drawPlayer.width, this.drawPlayer.height, 46, 0.0f, 0.0f, 150, new Color(), 0.2f);
          dust1.noGravity = true;
          dust1.fadeIn = 1.9f;
          this.DustCache.Add(dust1.dustIndex);
        }
      ...
      if (this.drawPlayer.venom)
      {
        ...
        {
          Dust dust1 = Dust.NewDustDirect(this.Position, this.drawPlayer.width, this.drawPlayer.height, 171, 0.0f, 0.0f, 100, new Color(), 0.5f);
          dust1.noGravity = true;
          dust1.fadeIn = 1.5f;
          this.DustCache.Add(dust1.dustIndex);
        }
      ...
      if (this.drawPlayer.onFire)
      {
        ...
        {
          Dust dust1 = Dust.NewDustDirect(new Vector2(this.Position.X - 2f, this.Position.Y - 2f), this.drawPlayer.width + 4, this.drawPlayer.height + 4, 6, this.drawPlayer.velocity.X * 0.4f, this.drawPlayer.velocity.Y * 0.4f, 100, new Color(), 3f);
          dust1.noGravity = true;
          dust1.velocity *= 1.8f;
      ...
      if (this.drawPlayer.dripping && (double) this.shadow == 0.0 && Main.rand.Next(4) != 0)
      {
        ...
        {
          Dust dust1 = Dust.NewDustDirect(position, this.drawPlayer.width + 4, this.drawPlayer.height + 2, 211, 0.0f, 0.0f, 50, new Color(), 0.8f);
          if (Main.rand.Next(2) == 0)
            dust1.alpha += 25;
          if (Main.rand.Next(2) == 0)
            dust1.alpha += 25;
          dust1.noLight = true;
          dust1.velocity *= 0.2f;
          dust1.velocity.Y += 0.2f;
          dust1.velocity += this.drawPlayer.velocity;
          this.DustCache.Add(dust1.dustIndex);
        }
        else
        {
          Dust dust1 = Dust.NewDustDirect(position, this.drawPlayer.width + 8, this.drawPlayer.height + 8, 211, 0.0f, 0.0f, 50, new Color(), 1.1f);
          if (Main.rand.Next(2) == 0)
            dust1.alpha += 25;
          if (Main.rand.Next(2) == 0)
            dust1.alpha += 25;
      ...
      if (this.drawPlayer.drippingSlime)
      {
        ...
        if (Main.rand.Next(4) != 0 && (double) this.shadow == 0.0)
        {
          ...
          if (Main.rand.Next(2) == 0)
          {
            Dust dust1 = Dust.NewDustDirect(position, this.drawPlayer.width + 4, this.drawPlayer.height + 2, 4, 0.0f, 0.0f, Alpha, newColor, 1.4f);
            if (Main.rand.Next(2) == 0)
              dust1.alpha += 25;
            if (Main.rand.Next(2) == 0)
              dust1.alpha += 25;
      ...
      if (this.drawPlayer.drippingSparkleSlime)
      {
        ...
        if (Main.rand.Next(4) != 0 && (double) this.shadow == 0.0)
        {
          ...
          if (Main.rand.Next(4) == 0)
          {
            ...
            rgb.A /= (byte) 2;
            Dust dust1 = Dust.NewDustDirect(position, this.drawPlayer.width + 4, this.drawPlayer.height + 2, 4, 0.0f, 0.0f, Alpha, rgb, 0.65f);
            if (Main.rand.Next(2) == 0)
              dust1.alpha += 25;
            if (Main.rand.Next(2) == 0)
              dust1.alpha += 25;
            dust1.noLight = true;
            dust1.velocity *= 0.2f;
            dust1.velocity += this.drawPlayer.velocity * 0.7f;
            dust1.fadeIn = 0.8f;
            this.DustCache.Add(dust1.dustIndex);
          }
      ...
      {
        Dust dust1 = Dust.NewDustDirect(new Vector2(this.Position.X - 2f, this.Position.Y - 2f), this.drawPlayer.width + 4, this.drawPlayer.height + 4, 226, 0.0f, 0.0f, 100, new Color(), 0.5f);
        dust1.velocity *= 1.6f;
        --dust1.velocity.Y;
        dust1.position = Vector2.Lerp(dust1.position, this.drawPlayer.Center, 0.5f);
        this.DustCache.Add(dust1.dustIndex);
      }
      if (this.drawPlayer.burned)
      {
        if ((double) this.shadow == 0.0)
        {
          Dust dust1 = Dust.NewDustDirect(new Vector2(this.Position.X - 2f, this.Position.Y - 2f), this.drawPlayer.width + 4, this.drawPlayer.height + 4, 6, this.drawPlayer.velocity.X * 0.4f, this.drawPlayer.velocity.Y * 0.4f, 100, new Color(), 2f);
          dust1.noGravity = true;
          dust1.velocity *= 1.8f;
          dust1.velocity.Y -= 0.75f;
          this.DustCache.Add(dust1.dustIndex);
        }
        R = 1f;
        B *= 0.6f;
      ...
      if (this.drawPlayer.onFrostBurn)
      {
        if (Main.rand.Next(4) == 0 && (double) this.shadow == 0.0)
        {
          Dust dust1 = Dust.NewDustDirect(new Vector2(this.Position.X - 2f, this.Position.Y - 2f), this.drawPlayer.width + 4, this.drawPlayer.height + 4, 135, this.drawPlayer.velocity.X * 0.4f, this.drawPlayer.velocity.Y * 0.4f, 100, new Color(), 3f);
          dust1.noGravity = true;
          dust1.velocity *= 1.8f;
          dust1.velocity.Y -= 0.5f;
          this.DustCache.Add(dust1.dustIndex);
      ...
      if (this.drawPlayer.onFire2)
      {
        if (Main.rand.Next(4) == 0 && (double) this.shadow == 0.0)
        {
          Dust dust1 = Dust.NewDustDirect(new Vector2(this.Position.X - 2f, this.Position.Y - 2f), this.drawPlayer.width + 4, this.drawPlayer.height + 4, 75, this.drawPlayer.velocity.X * 0.4f, this.drawPlayer.velocity.Y * 0.4f, 100, new Color(), 3f);
          dust1.noGravity = true;
          dust1.velocity *= 1.8f;
          dust1.velocity.Y -= 0.5f;
          this.DustCache.Add(dust1.dustIndex);
      ...
      if (this.drawPlayer.bleed)
      {
        ...
        {
          Dust dust1 = Dust.NewDustDirect(this.Position, this.drawPlayer.width, this.drawPlayer.height, 5, 0.0f, 0.0f, 0, new Color(), 1f);
          dust1.velocity.Y += 0.5f;
      ...
      if (this.drawPlayer.stinky && Main.instance.IsActive && !Main.gamePaused)
      {
        ...
        if (Main.rand.Next(5) == 0 && (double) this.shadow == 0.0)
        {
          ...
          int index = Dust.NewDust(this.Position, this.drawPlayer.width, this.drawPlayer.height, 188, vector2_2.X, vector2_2.Y * 0.5f, 100, new Color(), 1.5f);
      ...
      if (this.drawPlayer.slowOgreSpit && Main.instance.IsActive && !Main.gamePaused)
      {
        ...
        if (Main.rand.Next(5) == 0 && (double) this.shadow == 0.0)
        {
          ...
          Dust dust1 = Main.dust[Dust.NewDust(this.Position, this.drawPlayer.width, this.drawPlayer.height, Type, 0.0f, 0.0f, 100, new Color(), 1f)];
      ...
      {
        float num13 = (float) this.drawPlayer.miscCounter / 180f;
        float num14 = 0.0f;
        float num15 = 10f;
        int Type = 90;
        int num16 = 0;
        for (int index1 = 0; index1 < 3; ++index1)
        {
          switch (index1)
          {
            case 0:
              ...
              {
                num14 = 6.283185f / (float) this.drawPlayer.nebulaLevelLife;
                num16 = this.drawPlayer.nebulaLevelLife;
                goto default;
              }
              else
                break;
            case 1:
              ...
              {
                num14 = -6.283185f / (float) this.drawPlayer.nebulaLevelMana;
                num16 = this.drawPlayer.nebulaLevelMana;
                num13 = (float) -this.drawPlayer.miscCounter / 180f;
                num15 = 20f;
                Type = 88;
                goto default;
              }
            ...
            case 2:
              ...
              {
                num14 = 6.283185f / (float) this.drawPlayer.nebulaLevelDamage;
                num16 = this.drawPlayer.nebulaLevelDamage;
                num13 = (float) this.drawPlayer.miscCounter / 180f;
                num15 = 30f;
                Type = 86;
                goto default;
            ...
            default:
              ...
              {
                Dust dust1 = Dust.NewDustDirect(this.Position, this.drawPlayer.width, this.drawPlayer.height, Type, 0.0f, 0.0f, 100, new Color(), 1.5f);
                dust1.noGravity = true;
                dust1.velocity = Vector2.Zero;
                dust1.position = this.drawPlayer.Center + Vector2.UnitY * this.drawPlayer.gfxOffY + ((float) ((double) num13 * 6.28318548202515 + (double) num14 * (double) index2)).ToRotationVector2() * num15;
                dust1.customData = (object) this.drawPlayer;
                this.DustCache.Add(dust1.dustIndex);
              }
              break;
          }
      ...
      {
        Dust dust1 = Dust.NewDustDirect(new Vector2(this.Position.X - 2f, this.Position.Y - 2f), this.drawPlayer.width + 4, this.drawPlayer.height + 4, 272, 0.0f, 0.0f, 50, new Color(), 0.5f);
        dust1.velocity *= 1.6f;
        --dust1.velocity.Y;
        dust1.position = Vector2.Lerp(dust1.position, this.drawPlayer.Center, 0.5f);
        this.DustCache.Add(dust1.dustIndex);
      ...
      {
        float num13 = 1.2f;
        this.colorEyeWhites = Color.White * num13;
        this.colorEyes = this.drawPlayer.eyeColor * num13;
        this.colorHair = GameShaders.Hair.GetColor((short) this.drawPlayer.hairDye, this.drawPlayer, Color.White);
        this.colorHead = this.drawPlayer.skinColor * num13;
        this.colorBodySkin = this.drawPlayer.skinColor * num13;
        this.colorShirt = this.drawPlayer.shirtColor * num13;
        this.colorUnderShirt = this.drawPlayer.underShirtColor * num13;
        this.colorPants = this.drawPlayer.pantsColor * num13;
        this.colorShoes = this.drawPlayer.shoeColor * num13;
        this.colorLegs = this.drawPlayer.skinColor * num13;
      }
      this.stealth = 1f;
      if (this.heldItem.type == 3106)
      {
        float num13 = this.drawPlayer.stealth;
        if ((double) num13 < 0.03)
          num13 = 0.03f;
        float num14 = (float) ((1.0 + (double) num13 * 10.0) / 11.0);
        if ((double) num13 < 0.0)
          num13 = 0.0f;
        if ((double) num13 >= 1.0 - (double) this.shadow && (double) this.shadow > 0.0)
          num13 = this.shadow * 0.5f;
        this.stealth = num14;
        this.colorArmorHead = new Color((int) (byte) ((double) this.colorArmorHead.R * (double) num13), (int) (byte) ((double) this.colorArmorHead.G * (double) num13), (int) (byte) ((double) this.colorArmorHead.B * (double) num14), (int) (byte) ((double) this.colorArmorHead.A * (double) num13));
        this.colorArmorBody = new Color((int) (byte) ((double) this.colorArmorBody.R * (double) num13), (int) (byte) ((double) this.colorArmorBody.G * (double) num13), (int) (byte) ((double) this.colorArmorBody.B * (double) num14), (int) (byte) ((double) this.colorArmorBody.A * (double) num13));
        this.colorArmorLegs = new Color((int) (byte) ((double) this.colorArmorLegs.R * (double) num13), (int) (byte) ((double) this.colorArmorLegs.G * (double) num13), (int) (byte) ((double) this.colorArmorLegs.B * (double) num14), (int) (byte) ((double) this.colorArmorLegs.A * (double) num13));
        float scale = num13 * num13;
      ...
      else if (this.drawPlayer.setVortex)
      {
        ...
        if ((double) num13 >= 1.0 - (double) this.shadow && (double) this.shadow > 0.0)
          num13 = this.shadow * 0.5f;
        this.stealth = num13;
        Color secondColor = new Color(Vector4.Lerp(Vector4.One, new Vector4(0.0f, 0.12f, 0.16f, 0.0f), 1f - num13));
