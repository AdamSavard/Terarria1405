  ...
  public class InGamePopups
  {
    public class AchievementUnlockedPopup : IInGameNotification
    {
      ...
      public AchievementUnlockedPopup(Achievement achievement)
      {
        ...
        this._achievementTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievements", (AssetRequestMode) 2);
        this._achievementBorderTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievement_Borders", (AssetRequestMode) 2);
      }
    ...
    public class PlayerWantsToJoinGamePopup : IInGameNotification
    {
      ...
      public void DrawInGame(SpriteBatch spriteBatch, Vector2 bottomAnchorPosition)
      {
        ...
        Color color = new Color((int) Main.mouseTextColor, (int) Main.mouseTextColor, (int) Main.mouseTextColor / 5, (int) Main.mouseTextColor);
        Utils.DrawBorderString(spriteBatch, text, R.Center.ToVector2() + new Vector2(10f, 0.0f), color * opacity, num * 0.9f, 0.5f, 0.4f, -1);
      }
        ...
        ref int gamepadPointLocalIndexTouse)
      {
        ...
        pos.X += 6f;
        Color color = new Color((int) Main.mouseTextColor, (int) Main.mouseTextColor, (int) Main.mouseTextColor / 5, (int) Main.mouseTextColor);
        Utils.DrawBorderString(spriteBatch, text, pos, color, 0.9f, 0.0f, 0.4f, -1);
      }
    }
  }
}
