...
namespace Terraria.UI
{
  public class AchievementAdvisor
  {
    ...
    public bool CanDrawAboveCoins
    {
      get
      {
        return Main.screenWidth >= 1000 && !PlayerInput.UsingGamepad;
      }
    }

    public void LoadContent()
    {
      this._achievementsTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievements", (AssetRequestMode) 1);
      this._achievementsBorderTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievement_Borders", (AssetRequestMode) 1);
      this._achievementsBorderMouseHoverFatTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievement_Borders_MouseHover", (AssetRequestMode) 1);
      this._achievementsBorderMouseHoverThinTexture = (Asset<Texture2D>) Main.Assets.Request<Texture2D>("Images/UI/Achievement_Borders_MouseHoverThin", (AssetRequestMode) 1);
    }
    ...
    public void DrawMouseHover()
    {
      ...
      obj.value = -1;
      Main.HoverItem = obj;
      Main.instance.MouseText("", 0, (byte) 0, -1, -1, -1, -1, 0);
      Main.mouseText = true;
    }
