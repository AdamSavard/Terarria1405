...
namespace Terraria
{
  public static class Utils
  {
    ...
    {
      return (float) (1.0 - (Math.Cos((double) value * 6.28318548202515) * 0.5 + 0.5));
    }
    ...
    {
      return string.Format("{0:" + originalFormat + "}", (object) percent).TrimEnd('0', '%', ' ').TrimEnd('.', ' ').TrimStart('0', ' ') + "%";
    }
      ...
      Utils.TileActionAttempt plot)
    {
      ...
      return Utils.PlotLine(tileCoordinates3.X, tileCoordinates3.Y, tileCoordinates4.X, tileCoordinates4.Y, (Utils.TileActionAttempt) ((x, y) => Utils.PlotLine(x + lineMinOffset.X, y + lineMinOffset.Y, x + lineMaxOffset.X, y + lineMaxOffset.Y, plot, false)), true);
    }
