...
namespace Terraria.Graphics.Light
{
  public class TileLightScanner
  {
    ...
    {
      return TileLightScanner.GetTileMask(this._world.Tiles[x, y]);
    }
      ...
      if (Main.tileLighted[(int) tile.type])
      {
        switch (tile.type)
        {
          ...
          case 578:
            ...
            {
              float num5 = (float) localRandom.Next(28, 42) * 0.005f + (float) (270 - (int) Main.mouseTextColor) / 1000f;
              R = 0.0f;
              G = (float) (0.200000002980232 + (double) num5 / 2.0);
              B = 1f;
              break;
            }
            break;
          ...
          case 84:
            ...
            {
              case 2:
                float num7 = (float) (270 - (int) Main.mouseTextColor) / 800f;
                if ((double) num7 > 1.0)
                  num7 = 1f;
          ...
          case 173:
            ...
            break;
          case 125:
            float num10 = (float) localRandom.Next(28, 42) * 0.01f + (float) (270 - (int) Main.mouseTextColor) / 800f;
            G = lightColor.Y = 0.3f * num10;
            B = lightColor.Z = 0.6f * num10;
            break;
          case 126:
            if (tile.frameX < (short) 36)
            {
          ...
          case 209:
            ...
            {
              Vector3 vector3_6 = PortalHelper.GetPortalColor(Main.myPlayer, 1).ToVector3() * 0.65f;
              R = vector3_6.X;
              G = vector3_6.Y;
              B = vector3_6.Z;
              break;
          ...
          case 215:
            if (tile.frameY < (short) 36)
            {
              float num5 = (float) localRandom.Next(28, 42) * 0.005f + (float) (270 - (int) Main.mouseTextColor) / 700f;
              float num6;
              float num12;
              float num13;
              switch ((int) tile.frameX / 54)
              {
                case 1:
                  ...
                  break;
                case 2:
                  num6 = (float) (0.5 * (double) Main.demonTorch + 1.0 * (1.0 - (double) Main.demonTorch));
                  num12 = 0.3f;
                  num13 = (float) (1.0 * (double) Main.demonTorch + 0.5 * (1.0 - (double) Main.demonTorch));
                  break;
                case 3:
                  num6 = 0.45f;
                  num12 = 0.75f;
                ...
                case 4:
                  ...
                  break;
                case 5:
                  num6 = (float) Main.DiscoR / (float) byte.MaxValue;
                  num12 = (float) Main.DiscoG / (float) byte.MaxValue;
                  num13 = (float) Main.DiscoB / (float) byte.MaxValue;
                  break;
                case 6:
                  num6 = 0.75f;
                  num12 = 1.2825f;
          ...
          case 429:
            ...
            bool flag2 = num17 % 2 >= 1;
            bool flag3 = num17 % 4 >= 2;
            bool flag4 = num17 % 8 >= 4;
            int num18 = num17 % 16 >= 8 ? 1 : 0;
            if (flag2)
              R += 0.5f;
            if (flag3)
              G += 0.5f;
