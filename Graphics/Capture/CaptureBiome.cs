...
namespace Terraria.Graphics.Capture
{
  public class CaptureBiome
  {
    ...
    public static CaptureBiome[] BiomesByWaterStyle = new CaptureBiome[15]
    {
      ...
      new CaptureBiome(6, 4, CaptureBiome.TileColorStyle.Normal),
      new CaptureBiome(7, 5, CaptureBiome.TileColorStyle.Normal),
      new CaptureBiome(2, 6, CaptureBiome.TileColorStyle.Normal),
      new CaptureBiome(0, 7, CaptureBiome.TileColorStyle.Normal),
      new CaptureBiome(0, 8, CaptureBiome.TileColorStyle.Normal),
      new CaptureBiome(0, 9, CaptureBiome.TileColorStyle.Normal),
      new CaptureBiome(8, 10, CaptureBiome.TileColorStyle.Crimson),
      null,
      new CaptureBiome(2, 12, CaptureBiome.TileColorStyle.Normal),
      new CaptureBiome(4, 0, CaptureBiome.TileColorStyle.Normal),
    ...
    public class Styles
    {
      ...
      public static CaptureBiome Ocean = new CaptureBiome(4, 0, CaptureBiome.TileColorStyle.Normal);
